...
public class category extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rcategory=inflater.inflate(R.layout.fragment_category, container, false);
        pd=new ProgressDialog(getContext());
        pd.setMessage("Loading");
        mycommand=new Mycommand(getContext());
        rvcategory=(RecyclerView)rcategory.findViewById(R.id.rvcategory);
        tvcategory=(TextView)rcategory.findViewById(R.id.ccategory);
    ...
    private void loadvdata(final String categoryy){

        String url="http://"+externalurl+"/android/loadfromcategories.php";
        StringRequest request=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(!response.isEmpty()){
                    if(response.contains("no entry")){
                        ...
                        rvcategory.setAdapter(verticoadapter);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                paramms.put("category", categoryy);
                return paramms;
            }
        };
